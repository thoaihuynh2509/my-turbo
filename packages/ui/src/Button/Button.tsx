...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses =
      "inline-flex items-center justify-center gap-2 border font-medium cursor-pointer transition-all duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
    ...
    const variantClasses = {
      ...
      secondary:
        "bg-gray-600 text-white border-gray-600 hover:bg-gray-700 hover:border-gray-700 focus-visible:outline-gray-600",
      ghost:
        "bg-transparent text-gray-700 border-transparent hover:bg-gray-100 focus-visible:outline-gray-600",
      danger:
